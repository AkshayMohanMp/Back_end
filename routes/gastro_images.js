...
const{GastroimageModel} =require("../model");
const { getAllImage, getSingleImagebyId, AddNewImage, UpdateImage, DeleteImageById} = require("../controller/imagescontroller/gastroimagecontroller");
